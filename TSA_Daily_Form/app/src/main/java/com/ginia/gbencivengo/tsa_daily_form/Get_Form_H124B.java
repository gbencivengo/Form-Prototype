...
public class Get_Form_H124B extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_get__form__h124_b);
        getTableData();
    }
    ...
    private void getTableData()
    {
        ...
        String url ="http://www.membergw.org/Android/getZYXForms.php";
    ...
    private void parseJSON(String jsonString) throws JSONException
    {
        ...
        ListView FormListView = (ListView)findViewById(R.id.Form_H124B_Table);
